export const faqs = [
  {
    question: "Where do you find data?",
    answer:
      "Vstree is enabled by its community, and much of the data is submitted by reputable users that help",
  },
  {
  ...
  },
  {
    ...
    answer: `We have bundles of ideas for how to keep improving vstree. We'll be publishing a list of features we plan to add in the coming weeks. Subscribe to our newsletter to stay up to date.`,
  },
  {
